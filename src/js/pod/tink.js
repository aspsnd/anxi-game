import { mouseUtil } from "../../libs/mouse";
...
export class Tink {
    ...
    makePointer(element = this.element, scale = this.scale) {
        ...
        let pointer = {
            ...
            get cursor() {
                return mouseUtil.now;
            },
            set cursor(value) {
                mouseUtil.now = value;
                this.element.style.cursor = `url("./res/util/_base/${value}.png") ${mouseUtil.relapos[value][0]} ${mouseUtil.relapos[value][1]}, auto`;
            },
    ...
    updateButtons() {
        ...
        this.pointers.forEach(pointer => {
            ...
            this.buttons.forEach(o => {
                ...
                if (o.enabled && o.worldVisible && o.parent != null) {
